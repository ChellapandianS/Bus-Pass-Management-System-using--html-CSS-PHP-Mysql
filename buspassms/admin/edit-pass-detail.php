...
{               ?> 
  <p colspan="8" style="font-size:20px;color:blue;text-align: center;">
...
<option value="Any Other Govt Issued Doc">Any Other Govt Issued Doc</option>
    ...
    <div class="form-group"> <label for="exampleInputEmail1">Source</label> <input type="text" name="source" value="<?php  echo $row->source;?>" class="form-control" required='true'> </div>
     <div class="form-group"> <label for="exampleInputEmail1">Destination</label> <input type="text" name="destination" value="<?php  echo $row->des;?>" class="form-control" required='true'> </div>
